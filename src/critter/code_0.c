...
typedef struct CritterStruct5Sub8 {
    s16 unk0;
    s16 unk2;
    s16 unk4;
    s16 unk6;
...
typedef struct CritterControllerSub4 {
    u8 unk0;
    u8 pad1[0xC - 0x1];
} CritterControllerSub4;
...
static Struct80029BAC D_critter_80029BAC[8][5] = {
    // 0
    {
        
        { {0x000F, 0x00E1, 0x000E, 0x0028, 0x0000, 0x0000, 0x00000037, 0x00000BD1}, 0x14, 0, },
        { {0x0014, 0x0190, 0x0018, 0x0028, 0x0000, 0x0000, 0x0000003C, 0x00000E10}, 0, 0, },
        { {0x000F, 0x00E1, 0x0010, 0x001E, 0x0000, 0x0000, 0x0000002D, 0x000007E9}, 0xC, 0, },
        { {0x000E, 0x00C4, 0x000C, 0x0014, 0x0000, 0x0000, 0x00000022, 0x00000484}, 0x8, 0, },
        { {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00000000, 0x00000000}, 0, 0, },
    },
    // 1
    {
        { {0x000F, 0x00E1, 0x000C, 0x0028, 0x0000, 0x0000, 0x00000037, 0x00000BD1}, 0x000E, 0x0000, },
        { {0x0014, 0x0190, 0x0018, 0x0028, 0x0000, 0x0000, 0x0000003C, 0x00000E10}, 0x0000, 0x0000, },
        { {0x000F, 0x00E1, 0x000E, 0x001E, 0x0000, 0x0000, 0x0000002D, 0x000007E9}, 0x000A, 0x0000, },
        { {0x000E, 0x00C4, 0x000C, 0x0014, 0x0000, 0x0000, 0x00000022, 0x00000484}, 0x0008, 0x0000, },
        { {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00000000, 0x00000000}, 0x0000, 0x0000, },
    },
    // 2
    {
        { {0x0012, 0x0144, 0x0010, 0x0028, 0x0000, 0x0000, 0x0000003A, 0x00000D24}, 0x0014, 0x0000, },
        { {0x0014, 0x0190, 0x0018, 0x0028, 0x0000, 0x0000, 0x0000003C, 0x00000E10}, 0x0000, 0x0000, },
        { {0x0012, 0x0144, 0x0012, 0x001E, 0x0000, 0x0000, 0x00000030, 0x00000900}, 0x000C, 0x0000, },
        { {0x000E, 0x00C4, 0x000C, 0x0014, 0x0000, 0x0000, 0x00000022, 0x00000484}, 0x0008, 0x0000, },
        { {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00000000, 0x00000000}, 0x0000, 0x0000, },
    },
    // 3
    {
        { {0x000F, 0x00E1, 0x0010, 0x0028, 0x0000, 0x0000, 0x00000037, 0x00000BD1}, 0x0014, 0x0000, },
        { {0x0014, 0x0190, 0x0018, 0x0028, 0x0000, 0x0000, 0x0000003C, 0x00000E10}, 0x0000, 0x0000, },
        { {0x000F, 0x00E1, 0x0012, 0x001E, 0x0000, 0x0000, 0x0000002D, 0x000007E9}, 0x000C, 0x0000, },
        { {0x000E, 0x00C4, 0x000C, 0x0014, 0x0000, 0x0000, 0x00000022, 0x00000484}, 0x0008, 0x0000, },
        { {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00000000, 0x00000000}, 0x0000, 0x0000, },   
    },
    // 4
    {
        { {0x0015, 0x01B9, 0x0018, 0x0028, 0x0000, 0x0000, 0x0000003D, 0x00000E89}, 0x0018, 0x0000, },
        { {0x0014, 0x0190, 0x0018, 0x0028, 0x0000, 0x0000, 0x0000003C, 0x00000E10}, 0x0000, 0x0000, },
        { {0x0015, 0x01B9, 0x001C, 0x001E, 0x0000, 0x0000, 0x00000033, 0x00000A29}, 0x0012, 0x0000, },
        { {0x000E, 0x00C4, 0x000C, 0x0014, 0x0000, 0x0000, 0x00000022, 0x00000484}, 0x0008, 0x0000, },
        { {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00000000, 0x00000000}, 0x0000, 0x0000, },   
    },
    // 5
    ...
    // 6
    {
        { {0x001E, 0x0384, 0x001C, 0x0028, 0x0000, 0x0000, 0x00000046, 0x00001324}, 0x001E, 0x0000, },
        { {0x0014, 0x0190, 0x0018, 0x0028, 0x0000, 0x0000, 0x0000003C, 0x00000E10}, 0x0000, 0x0000, },
        { {0x001E, 0x0384, 0x0020, 0x001E, 0x0000, 0x0000, 0x0000003C, 0x00000E10}, 0x0016, 0x0000, },
        { {0x000E, 0x00C4, 0x000C, 0x0014, 0x0000, 0x0000, 0x00000022, 0x00000484}, 0x0008, 0x0000, },
        { {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00000000, 0x00000000}, 0x0000, 0x0000, },   
    },
    // 7
    {
        { {0x000F, 0x00E1, 0x000C, 0x0028, 0x0000, 0x0000, 0x00000037, 0x00000BD1}, 0x000E, 0x0000, },
        { {0x0014, 0x0190, 0x0018, 0x0014, 0x0000, 0x0000, 0x00000028, 0x00000640}, 0xFFF6, 0x0000, },
        { {0x000F, 0x00E1, 0x000E, 0x001E, 0x0000, 0x0000, 0x0000002D, 0x000007E9}, 0x000A, 0x0000, },
        { {0x000E, 0x00C4, 0x000C, 0x0014, 0x0000, 0x0000, 0x00000022, 0x00000484}, 0x0008, 0x0000, },
        { {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00000000, 0x00000000}, 0x0000, 0x0000, },
    },
...
Gfx *func_critter_80024C88(Gfx *dl, Struct800247F4 *arg1) {
    f32 sp70[4][4];
    f32 sp6C;
    ...
    if (D_critter_80029BA8 != arg1->unk1E8) {
        ...
        gDPSetTile(dl++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0x0000, G_TX_LOADTILE, 0, G_TX_NOMIRROR | G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_CLAMP, 5, G_TX_NOLOD);\
        gDPLoadSync(dl++);\
        gDPLoadBlock(dl++, G_TX_LOADTILE, 0, 0, 1023, 256);\
        gDPPipeSync(dl++);\
        gDPSetTile(dl++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0x0000, G_TX_RENDERTILE, 0, G_TX_NOMIRROR | G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_CLAMP, 5, G_TX_NOLOD);
        gDPSetTileSize(dl++, G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C);
    }
    func_critter_80025A3C(arg1);
    gSPMatrix(dl++, arg1->unk60[D_global_asm_807444FC], G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    func_global_asm_80612CA0(sp70, sp6C);
    guMtxF2L(sp70, arg1->unkE0[D_global_asm_807444FC]);
    gSPMatrix(dl++, arg1->unkE0[D_global_asm_807444FC], G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);
    gSPVertex(dl++, &D_critter_800297F0, 4, 0);
    gSP2Triangles(dl++, 0, 1, 2, 0, 0, 2, 3, 0);
    gSPPopMatrix(dl++, G_MTX_MODELVIEW);
    func_global_asm_80612CA0(sp70, -sp6C);
    guMtxF2L(sp70, arg1->unk160[D_global_asm_807444FC]);
    gSPMatrix(dl++, arg1->unk160[D_global_asm_807444FC], G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);
    gSPVertex(dl++, &D_critter_80029830, 4, 0);
    gSP2Triangles(dl++, 0, 1, 2, 0, 0, 2, 3, 0);
    gSPPopMatrix(dl++, G_MTX_MODELVIEW);
    gDPPipeSync(dl++);
    return dl;
...
void func_critter_80026904(Critter *arg0, CritterController *arg1) {
    ...
    if (arg0->unk1E2 == 0) {
        if (arg0->unk58->unk25 != 0) {
            ...
            if ((arg0->unk1E0 == 2) && (arg0->unk3C < D_critter_80029BA4->unk8.unk2)) {
                s16 temp;
                temp = func_global_asm_80665DE0(arg0->x_pos, arg0->z_pos, gCurrentPlayer->x_position, gCurrentPlayer->z_position);
...
void func_critter_80026C9C(CritterController *arg0) {
    ...
    if (arg0 != NULL) {
        phi_s0 = arg0->unk4;
        D_critter_80029BA4->x_position = gCurrentPlayer->x_position;
        D_critter_80029BA4->z_position = gCurrentPlayer->z_position;
