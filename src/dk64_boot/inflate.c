  ...
  for (; k <= g; k++)
  {
     ...
     while (a--)
     {
       ...
       while (k > w + l)
       {
        ...
        //q = D_80007290 + hufts;
        q = D_80013AB0 + D_80013ABC;
        
        // hufts += z + 1;         /* track memory usage */
        D_80013ABC += z + 1;         /* track memory usage */
...
/* static */ int func_80001700(struct huft *tl, struct huft *td, s32 bl, s32 bd) // int inflate_codes(struct huft *tl, struct huft *td, s32 bl, s32 bd)
{
  ...
  k = D_80013AB8; // k = bk;
  w = D_80013AF0; // w = wp; /* initialize window position */
...
/* decompress an inflated block */
{
  ...
  /* inflate that block type */
   if (t == 2)
     return func_80001DB0(); //return inflate_dynamic();
   if (t == 0)
     return func_80001AF4(); //return inflate_stored();
   if (t == 1)
     return func_80001C48(); //return inflate_fixed();
