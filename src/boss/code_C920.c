...
void func_boss_80030920(s32 arg0) {
    ...
    func_global_asm_8061C464(D_global_asm_807F5D10, player_pointer, 4, 0x800, 0x5A, 0, 0x46, 0x64, 0x3A, 0, D_boss_80036AB0);
}
...
void func_boss_80030AE0(BossStruct3 *arg0) {
    ...
    extra_player_info_pointer->unk1D8 = D_boss_80036AB4;
...
void func_boss_80030E58() {
    ...
    func_global_asm_806086CC(current_actor_pointer->x_position, 
