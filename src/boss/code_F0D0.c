...
void func_800334A4(Struct800334A4_arg0 *arg0, f32 arg1) {
    ...
    current_actor_pointer->x_position = D_807FDCA0->unk14[arg0->unk1].unk0 + ((D_807FDCA0->unk14[arg0->unk0].unk0 - D_807FDCA0->unk14[arg0->unk1].unk0) * temp_f2);
    current_actor_pointer->z_position = D_807FDCA0->unk14[arg0->unk1].unk4 + ((D_807FDCA0->unk14[arg0->unk0].unk4 - D_807FDCA0->unk14[arg0->unk1].unk4) * temp_f2);
