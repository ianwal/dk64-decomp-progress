...
void func_boss_80024000(void) {
    ...
    for (i = 0; i < 6; i++) {
        ...
        func_global_asm_8067E2E4(gCurrentActorPointer, sp48.unk0[i], 3.0f);
    }
    for (i = 0; i < 0xC; i++) {
        ...
        drawSpriteAtPosition(&D_global_asm_8071FFA0, 2.5f, gCurrentActorPointer->x_position, gCurrentActorPointer->y_position + 40.0f, gCurrentActorPointer->z_position);
    }
}
...
void func_boss_80024300(void) {
    ...
    var_a0 = gCurrentActorPointer->animation_state->unk24;
    var_a3 = 0;
    var_v1 = 0xFF;
    ...
    if (var_a3 != 0) {
        playSoundAtPosition(gCurrentActorPointer->x_position, gCurrentActorPointer->y_position, gCurrentActorPointer->z_position, var_a3, var_v1, 0x7F, 1, 0x1E, 0.3f, 0);
    }
    gCurrentActorPointer->animation_state->unk24[5].unk4 = 99999.0f;
    for (i = 0; i < 0xD; i++) {
...
void func_boss_80024524(u8 arg0, s16 arg1) {
    ...
    temp_v0 = &gCurrentActorPointer->animation_state->unk1C[arg0];
    if (arg0 == 3) {
        temp_v0->unk1 = 0x2F;
    }
    temp_v0->unk2 = arg1;
...
void func_boss_80024EAC(void) {
    ...
    sp2A = gCurrentActorPointer->animation_state->unk64;
    func_global_asm_806CC10C(D_global_asm_807FDC90->unk8, gCurrentActorPointer->y_rotation);
    func_global_asm_8072AB74(0x45, D_global_asm_807FDC94->x_position, D_global_asm_807FDC94->z_position, 0x16, 0);
    temp_v0 = func_global_asm_806CC10C(D_global_asm_807FDC90->unk8, gCurrentActorPointer->y_rotation);
    if (temp_v0 > 0) {
        if (sp2A != 0x260) {
            playActorAnimation(gCurrentActorPointer, 0x260);
        }
    } else if (temp_v0 < 0) {
        if (sp2A != 0x25F) {
            playActorAnimation(gCurrentActorPointer, 0x25F);
        }
    } else if (sp2A != 0x25A) {
        playActorAnimation(gCurrentActorPointer, 0x25A);
...
void func_boss_80024FA8(s32 arg0, Struct8002450C *arg1, s32 arg2, u8 *arg3) {
    ...
    switch (gCurrentActorPointer->control_state_progress) {
        ...
        case 3:
            while (arg3[i] != 0xFF) {
                if ((gCurrentActorPointer->control_state == 0x27) || (gCurrentActorPointer->control_state == 0x2E)) {
            ...
            if (phi_v0 != 0) {
                ...
                func_global_asm_8068842C(gCurrentActorPointer, 1, 1);
            }
            return;
    }
}
...
void func_boss_8002531C(void) {
    ...
    func_global_asm_8066EA90(gCurrentActorPointer, 5);
}

void func_boss_80025364(void) {
    func_global_asm_8066EA64(gCurrentActorPointer, 3);
    func_global_asm_8066EA64(gCurrentActorPointer, 4);
    func_global_asm_8066EA64(gCurrentActorPointer, 5);
}

void func_boss_800253AC(void) {
    f32 scale;

    scale = ((f32)((f32)(((MAX(gCurrentActorPointer->y_velocity, 0.0) / 150.0)) * 0.12) + 0.3) * 4.0f);
    func_global_asm_807149B8(1);
    ...
    func_global_asm_80714C08(&D_global_asm_80720120, scale, gCurrentActorPointer, 3, 0);
    func_global_asm_807149B8(1);
    func_global_asm_8071498C(func_global_asm_8071AF30);
    func_global_asm_807149A8(1000);
    func_global_asm_80714950((s32)gCurrentActorPointer);
    func_global_asm_80714C08(&D_global_asm_80720120, scale, gCurrentActorPointer, 4, 0);
}
