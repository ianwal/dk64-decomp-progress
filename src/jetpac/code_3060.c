...
f32 func_80027210(void) {
    return ((rand() >> 0xF) % 60000) / D_8002EB70;
}

int func_80027250(f32 arg0, f32 arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7) {
    f32 sp44;
    f32 sp40;
    f32 sp3C;
    f32 sp38;
    ...
    func_80027108(arg0, arg2, &sp44, &sp40, &sp3C, &sp38);
    func_80027108(arg4, arg6, &sp34, &sp30, &sp2C, &sp28);
    return func_80027060(sp44, arg1, sp40, arg3, sp34, arg5, sp30, arg7)
        || func_80027060(sp3C, arg1, sp38, arg3, sp2C, arg5, sp28, arg7);
}
