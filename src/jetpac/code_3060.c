...
f32 func_jetpac_80027210(void) {
    return ((rand() >> 0xF) % 60000) / D_jetpac_8002EB70;
}
...
f32 func_jetpac_80027380(JetpacStruct44 *arg0) {
    return (arg0->unk0 + arg0->unk1C) + ((f32)(arg0->unk24 - arg0->unk1C) * 0.5);
}

f32 func_jetpac_800273C8(JetpacStruct44 *arg0) {
