...
extern JetpacStruct D_8002F1DC[6];
...
extern s32 D_8002F050; // TODO: Datatype
extern f32 D_8002F054;
extern s32 D_8002F078;
...
f32 func_80027210();
void func_80029B90();
f32 func_80027380(s32 *);
f32 func_800273C8(JetpacStruct *);
f32 func_8002A2DC(f32, f32);
//void func_8002A67C(JetpacStruct *);
f32 func_80027210();
s32 func_80027250(f32, f32, f32, f32, f32, f32, f32, f32);
extern void (func_8002A758)();
void func_8002A374(JetpacStruct*);
void func_8002A530(JetpacStruct *arg0);
...
/*
s32 func_80029064(JetpacStruct *arg0) {
    s32 var_v1;

    var_v1 = 0;
    if (D_8002EC30.unk434 == 3) {
        var_v1 = func_80027250(
            arg0->unk0 + arg0->unk1C,
            arg0->unk4 + arg0->unk20,
            arg0->unk24 + arg0->unk0,
            arg0->unk28 + arg0->unk4,
            D_8002EC30.unk420 + (D_8002EC30.unk43C + 2),
            D_8002EC30.unk424 + (D_8002EC30.unk440 + 4),
            D_8002EC30.unk444 + (D_8002EC30.unk420 - 2),
            D_8002EC30.unk448 + D_8002EC30.unk424
        );
    }
    if (var_v1 != 0) {
        D_8002F064 = 4;
        D_8002F07C = 0;
        func_80027010(&D_8002F050, arg0);
        func_800291AC(arg0);
    }
    return var_v1;
}
...
void func_80029204(JetpacStruct *arg0) {
    if (arg0->unk14 == 3) {
        func_80025700(arg0->unk4C, arg0->unk0, arg0->unk4, &arg0->unk10, arg0->unk18);
        return;
    }
    if (arg0->unk14 == 4) {
...
void func_8002A374(JetpacStruct *arg0) {
    f32 temp_f0;
    f32 temp_f2;
    f32 var_f14;
    f32 sp28;
    ...
    sp18 = func_80027380(arg0);
    temp_f0 = func_80027380(&D_8002F050);
    ...
    temp_f12 = (D_8002F054 + D_8002F078) - func_800273C8(arg0);
    if (temp_f12 > 0.0f) {
    ...
    arg0->unk8 = func_8002A2DC(sp28, arg0->unk8);
    arg0->unkC = func_8002A2DC(sp1C, arg0->unkC);
}
...
extern f64 D_8002EC20;

/*
// TODO: Close...ish
void func_8002A758(JetpacStruct *arg0) {
    s32 temp_v0_2;

    switch (arg0->unk14) {
        case 3:
            arg0->unkC = arg0->unkC + D_8002EC20;
            temp_v0_2 = func_80028CF8(
                        arg0->unk1C + arg0->unk0 + arg0->unk8,
                        arg0->unk20 + arg0->unk4 + arg0->unkC,
                        arg0->unk24 + arg0->unk0 + arg0->unk8,
...
void func_8002ABDC(void) {
    ...
    if (count < 3 && D_8002E8F0 >= 6) {
        D_8002E8F0 = func_80027210() * 5.0f;
    }
    if (D_8002E8F0 == 0 && D_8002F3BC == 2) {
        func_80029450();
        count++;
        if (count < 3) {
            D_8002E8F0 = func_80027210() * 5.0f;
