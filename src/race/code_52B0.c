...
void func_race_800294A8(void) {
    ...
    if (!(gCurrentActorPointer->object_properties_bitfield & 0x10)) {
        ...
        aaD->unk44 = 5;
        func_global_asm_8066E5F8(gCurrentActorPointer, 2, 0xC);
    }
    ...
    if (aaD->unk34 < 5) {
        if (aaD->unk34 == 1) {
            ...
            if (temp_s0->unk1C == 0x3C) {
                func_global_asm_8061C6A8(PaaD->unk104, gCurrentActorPointer, 4, 0x800, 0x32, 0, 0x28, 0x1E, 0x14, 0, 0.4f);
            }
        }
        if (aaD->unk34 == 2) {
            if (aaD->unk26 != 0) {
        ...
        if (!gameIsInDKTVMode()) {
            addActorToTextOverlayRenderArray(func_race_800292B0, gCurrentActorPointer, 3);
        }
    } else if (aaD->unk34 == 5) {
        if (aaD->unk35 == 0) {
...
void func_race_8002A0AC(void) {
    ...
    a178 = gCurrentActorPointer->a178;
    sp50 = gCurrentActorPointer->unk17C;
    ...
    if (!(gCurrentActorPointer->object_properties_bitfield & 0x10)) {
        ...
        gCurrentActorPointer->draw_distance = 1500;
        func_race_8002DE78(a180, 5, &D_race_8002FC20, &D_race_8002FC50);
        a178->unk34 = 0;
        func_global_asm_8061CC30();
        temp_a0 = playCutscene(gCurrentActorPointer, 1, 1) - 0x3C;
        aaD->unk1C = temp_a0;
        a180->unkA = temp_a0;
        a178->unk4 = 1.0f;
        ...
        gCurrentActorPointer->x_position = D_global_asm_807FDCA0->unk14[temp_a1].unk0;
        gCurrentActorPointer->y_position = D_global_asm_807FDCA0->unk14[temp_a1].unk2;
        gCurrentActorPointer->z_position = D_global_asm_807FDCA0->unk14[temp_a1].unk4;
        ...
        switch (a178->unk35) {
            case 0:
                if (!isFlagSet(PERMFLAG_ITEM_GB_GALLEON_SEALRACE, FLAG_TYPE_PERMANENT)) {
                    ...
                    playActorAnimation(gCurrentActorPointer, 0x29A);
                }
                a178->unk35++;
                break;
            case 1:
                if (func_global_asm_80629148()) {
                    sp34 = a180->unk4;
                    func_global_asm_80629174();
                    loadText(gCurrentActorPointer, 0x12, func_race_8002A080(a178, sp34));
                    a178->unk35++;
                }
                break;
            case 2:
    ...
    aaS = gCurrentActorPointer->animation_state;
    switch (aaS->unk64) {
        case 0x29E:
        case 0x2A2:
            var_f2 = MAX(0.1, gCurrentActorPointer->unkB8 * 0.0025f);
            func_global_asm_80614D00(gCurrentActorPointer, var_f2, 10.0f);
            break;
        case 0x2A0:
            if (aaS->unk0->unk10 == 0x4A7) {
                // TODO: a1 is wrong
                func_race_80029F88(gCurrentActorPointer, 0, gCurrentActorPointer->unkB8 - a180->unk0->unkB8, (sp48 - D_race_8002FC30[0].unk0) * 40.0f, 23.0f);
                break;
            }
        default:
            if (aaS->unk0->unk10 != 0x49B) {
                func_global_asm_80614D00(gCurrentActorPointer, 1.0f, 10.0f);
            }
            break;
    }
    renderActor(gCurrentActorPointer, 0);
