...
void func_806884B8(Actor *, s32, s32);
...
s32 func_806882DC(Actor *actor, s32 arg1, s16 arg2) {
    GlobalASMStruct60 *temp_v0 = func_80688584(actor, arg1);
...
void func_80688370(Actor* actor, s32 arg1, f32 arg2) {
    GlobalASMStruct60 *temp_v0 = func_80688584(actor, arg1);
...
void func_8068839C(Actor *actor, s32 arg1, u8 arg2) {
    GlobalASMStruct60 *temp_v0 = func_80688584(actor, arg1);
...
void func_806883C8(Actor* actor, s32 arg1, u8 arg2) {
    GlobalASMStruct60 *temp_v0 = func_80688584(actor, arg1);
...
void func_806884B8(Actor* actor, s32 arg1, s16 arg2) {
    GlobalASMStruct60 *temp_v0 = func_80688584(actor, arg1);
...
void func_80688514(Actor* actor, s32 arg1) {
    GlobalASMStruct60 *temp_v0 = func_80688584(actor, arg1);
...
s32 func_80688540(Actor* actor, s32 arg1) {
    GlobalASMStruct60 *temp_v0 = func_80688584(actor, arg1);
...
GlobalASMStruct60 *func_80688584(Actor *arg0, s32 arg1) {
...
void func_80688638(GlobalASMStruct60 **arg0) {
    ...
    while (phi_s2) {
        ...
        for (phi_s0 = 0; phi_s0 < phi_s2->unkA; phi_s0++) {
            func_8066B434(temp_s2->unk0, 0x1E6, 0x2C);
            temp_s2++;
        }
        func_8061130C(phi_s2->unk0);
        func_8061130C(phi_s2->unk4);
        temp_s0 = phi_s2->next;
        func_8061130C(phi_s2);
        phi_s2 = temp_s0;
    }
    *arg0 = NULL;
}
