...
void func_global_asm_806AD9F4(void) {
    ...
    if (((D_global_asm_807FBB70.unk200 == 9) || D_global_asm_807FBB70.unk15) && (current_actor_pointer->control_state != 0x37)) {
    ...
    switch (current_actor_pointer->control_state) {
        ...
        case 39:
            ...
            if ((current_actor_pointer->control_state_progress) && (D_global_asm_807FDC90->unk2C == 0)) {
    ...
    switch (current_actor_pointer->control_state) {
        ...
        case 1:
            if (func_global_asm_8072E22C(300)) {
                playActorAnimation(current_actor_pointer, 0x31AU);
        ...
        case 4:
            ...
            break;
        case 30:
            if (current_actor_pointer->animation_state->unk64 == 0x31AU) {
                current_actor_pointer->control_state = 0x23;
                current_actor_pointer->control_state_progress = 0;
            }
            break;
        case 35:
            if ((current_actor_pointer->animation_state->unk64 == 0x31AU) && (current_actor_pointer->animation_state->unk0->unk4 > 4.0f)) {
