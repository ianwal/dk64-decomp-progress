...
extern f32 D_global_asm_80758DF0;
extern f64 D_global_asm_80758DF8;
extern f64 D_global_asm_80758E00;
...
void func_global_asm_80663C60(f32 *arg0, s16 arg1) {
    ...
    if (current_map == MAP_CASTLE) {
        if (func_global_asm_8061CC00()) {
            phi_f2 = D_global_asm_80758DF0;
        } else {
            phi_f2 = 900.0f;
        }
        temp_f0 = *arg0;
        *arg0 = ((phi_f2 - temp_f0) * D_global_asm_80758DF8) + temp_f0;
    }
    for (phi_a0 = 0; phi_a0 < sp26; phi_a0++) {
        ...
        if (current_map == temp_v0->unk0 && (arg1 == temp_v0->unk2 || temp_v0->unk2 == -1)) {
            temp_f0_2 = *arg0;
            *arg0 = ((temp_v0->unk4 - temp_f0_2) * D_global_asm_80758E00) + temp_f0_2;
            return;
        }
    }
}
