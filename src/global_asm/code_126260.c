...
extern struct807FDB60 D_global_asm_807FDB60;
extern ActorRecolorStruct *D_global_asm_807FDB70;
extern s16 D_global_asm_807FDB76;
extern s16 D_global_asm_807FDB78;
extern s16 D_global_asm_807FDB7A;
extern s8 D_global_asm_807FDB7C;
extern s8 D_global_asm_807FDB7D;
extern s8 D_global_asm_807FDB7E;
extern u8 D_global_asm_807FDB7F;
extern u8 D_global_asm_807FDB80;

void func_global_asm_80721560(s16 arg0, s16 arg1, s16 arg2, u8 arg3, u8 arg4, u8 arg5) {
    D_global_asm_807FDB76 = arg0;
    D_global_asm_807FDB78 = arg1;
    D_global_asm_807FDB7A = arg2;
    D_global_asm_807FDB7E = arg3;
    D_global_asm_807FDB7F = arg4;
    D_global_asm_807FDB80 = arg5;
}

void func_global_asm_807215AC(s8 arg0, s8 arg1, s8 arg2) {
    D_global_asm_807FDB60.unkB = arg0;
    D_global_asm_807FDB60.unkC = arg1;
    D_global_asm_807FDB60.unkD = arg2;
}

void func_global_asm_807215D0(s8 arg0, s8 arg1) {
    D_global_asm_807FDB7C = arg0;
    D_global_asm_807FDB7D = arg1;
}

void func_global_asm_807215EC(void) {
    D_global_asm_807FDB60.unk8 = 0;
    D_global_asm_807FDB60.unkB = 0x6B;
    D_global_asm_807FDB60.unkC = 0x30;
    D_global_asm_807FDB60.unkD = 0x50;
    D_global_asm_807FDB60.unkE = 7;
    D_global_asm_807FDB60.unk6 = D_global_asm_807FDB60.unk8;
    D_global_asm_807FDB60.unk4 = D_global_asm_807FDB60.unk8;
    D_global_asm_807FDB70 = malloc(sizeof(ActorRecolorStruct) * 0x20);
...
extern u8 D_global_asm_807FDB74;
extern u8 D_global_asm_807FDB75;

void addActorRecolor(Actor *actor, s16 x, s16 y, s16 z, u8 alpha, u8 red, u8 green, u8 blue, u8 arg8) {
    u8 var_v0;
    ActorRecolorStruct *temp_v1;

    if (D_global_asm_807FDB74 >= 0x20) {
        D_global_asm_807FDB74--;
    }
    temp_v1 = &D_global_asm_807FDB70[D_global_asm_807FDB74++];
    temp_v1->unk0 = actor;
    temp_v1->x = x;
    temp_v1->y = y;
    temp_v1->z = z;
...
void func_global_asm_80722280(void) {
    D_global_asm_807FDB74 = 0;
    D_global_asm_807FDB75 = 0;
}
