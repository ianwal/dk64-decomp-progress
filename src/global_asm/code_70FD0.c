...
u8 func_global_asm_806730A4(s32, s32, s32, s32);
u8 func_global_asm_806734E4(s32, s32, s32, s32, s16 *, s16 *);
...
s8 func_global_asm_8066D2F4(Struct8066D250 *arg0);
...
s8 func_global_asm_8066D2F4(Struct8066D250 *arg0) {
    ...
    dx2 = arg0->vert[2].x - arg0->vert[0].x;
    dx1 = arg0->vert[1].x - arg0->vert[0].x;
    dy2 = arg0->vert[2].y - arg0->vert[0].y;
    dz2 = arg0->vert[2].z - arg0->vert[0].z;
    dy1 = arg0->vert[1].y - arg0->vert[0].y;
    dz1 = arg0->vert[1].z - arg0->vert[0].z;
    sp28 = (dz2 * dx1) - (dz1 * dx2);
    temp_f8_2 = (dy2 * dz1) - (dy1 * dz2);
    temp_f6_2 = (dx2 * dy1) - (dx1 * dy2);
    dxy = sqrtf(SQ(temp_f6_2) + SQ(temp_f8_2));
    if ((dxy < 0.01) && (dxy > -0.01)) {
        var_f2 = 1.57f;
    } else {
        var_f12 = ABS(sp28);
        var_f2 = func_global_asm_80611BB4(var_f12, dxy);
    }
...
u8 func_global_asm_80671E00(f32 arg0, f32 arg1, f32 arg2, f32 arg3, s16 *arg4, s16 *arg5, u8 arg6, u16 arg7) {
    ...
    *arg5 = 0xFFF;
    D_global_asm_807FB606 = 0;
    func_global_asm_80672E90(arg0, arg1, arg2);
    func_global_asm_80672C70(arg7);
    if (arg6) {
        sp4F = func_global_asm_806734E4(arg0, arg1, arg2, arg3, arg4, arg5);
        sp4F |= func_global_asm_80671F54(arg0, arg1, arg2, arg3, arg4, arg5);
    } else {
        sp4F = func_global_asm_806730A4(arg0, arg1, arg2, arg3);
        if (!sp4F) {
            sp4F = func_global_asm_80671F54(arg0, arg1, arg2, arg3, arg4, arg5);
        }
    }
