...
extern f64 D_global_asm_8075A798;
extern f32 D_global_asm_8075A7A0;
extern f32 D_global_asm_8075A7A4;
extern f64 D_global_asm_8075A7A8;
extern f64 D_global_asm_8075A978;
extern f32 D_global_asm_8075A980;
extern f64 D_global_asm_8075A988;
extern f32 D_global_asm_8075A990;
extern f32 D_global_asm_8075A9A0;
extern f64 D_global_asm_8075A9A8;
extern f32 D_global_asm_8075A9B0;
extern f32 D_global_asm_8075A9B4;
extern f32 D_global_asm_8075AA70;
...
Gfx *func_global_asm_806A3C6C(Gfx *dl, s32 arg1, u8 arg2, s32 arg3) {
    ...
    texture = func_global_asm_8068C12C(arg3 + 0x52);
    gDPPipeSync(dl++);
...
void func_global_asm_806A3DA0(f32 *arg0, f32 *arg1, f32 arg2, f32 arg3, AAD_global_asm_806A4DDC *arg4) {
    ...
    sp20 = arg2 * D_global_asm_8075A760;
...
void func_global_asm_806A4B84(f32 arg0, Actor *arg1, AAD_global_asm_806A4DDC *arg2, Struct806A57C0_2 *arg3, u8 arg4, u8 *arg5) {
    ...
    i = 0;
    var_s0 = arg3->unkC;
    var_f20 = (D_global_asm_8075A790 - arg3->unk14) * 0.5;
...
void func_global_asm_806A4DDC(Actor *arg0) {
    ...
    var_s1 = aaD->unkC;
    sp103 = FALSE;
    var_f0 = (1.0f - aaD->unk20) * D_global_asm_8075A798;
    if (var_f0 > 1.0f) {
        var_f0 = 1.0f;
    }
    aaD->unk40 = var_f0;
    func_global_asm_806A3DA0(&arg0->x_position, &arg0->y_position, aaD->unk20, var_f0, aaD);
    temp_f0 = (aaD->unk20 * D_global_asm_8075A7A0) * 0.5;
    aaD->unk44 = arg0->x_position - temp_f0;
    temp_f2 = (aaD->unk20 * D_global_asm_8075A7A4) * 0.5;
    ...
    while ((aaD->unk10 >= var_s0) && (var_s1 != NULL) && (sp103 == 0)) {
        ...
        if ((D_global_asm_8075A7A8 < temp_f2_5) && (arg0->control_state == 1)) {
            arg0->control_state = 2;
            aaD->unk18 = temp_f2_5 - D_global_asm_8075A7A8;
            sp103 = TRUE;
        } else {
            temp_a3 = var_s1;
...
void func_global_asm_806A57C0(AAD_global_asm_806A4DDC *arg0) {
    ...
    if ((var_v1 != NULL) && (var_v1->unkC->unk2 == 0)) {
        ...
        if (var_v0 < D_global_asm_8075A978) {
            arg0->unk14 = (D_global_asm_8075A978 - var_v0) * 0.5;
        } else {
            arg0->unk14 = 6.0f;
        }
    }
...
void func_global_asm_806A5868(void) {
    ...
    switch (current_actor_pointer->control_state) {
        ...
        case 2:
            ...
            var_a3->unk14 -= var_f0;
            var_a3->unk18 -= var_f0;
            if (var_a3->unk18 < D_global_asm_8075A988) {
                current_actor_pointer->control_state = 1;
            }
            break;
        case 4:
    ...
    if (current_actor_pointer->control_state != 5) {
        var_a3->unk20 = var_a3->unk0 * D_global_asm_8075A990;
        func_global_asm_806A5174(current_actor_pointer, var_a3, sp18);
        if (var_a3->unk0 != 0) {
            func_global_asm_806A4DDC(current_actor_pointer);
            func_global_asm_8068C350(&func_global_asm_806A4284, current_actor_pointer, 3);
        }
    }
}
*/
...
void func_global_asm_806A5DF0(s16 arg0, f32 arg1, f32 arg2, f32 arg3, s16 arg4, u8 arg5, s16 arg6, s32 arg7) {
    ...
    var_f0 = D_global_asm_8075A9A0;
    if (D_global_asm_807FBB68 & 0x10) {
        var_f0 = 2.0f * D_global_asm_8075A9A0;
    }
    sp2C[0] = arg5;
    sp2C[1] = arg4;
    sp2C[2] = arg6;
...
void func_global_asm_806A5EAC(AAD_global_asm_806A5EAC *arg0, void *arg1, f32 arg2) {
    ...
    func_global_asm_80714998(2);
    arg0->unk4 = func_global_asm_80714C08(arg1, arg2 * D_global_asm_8075A9A8, current_actor_pointer, 1, 2);
}
...
void func_global_asm_806A615C(void) {
    ...
    if ((current_actor_pointer->object_properties_bitfield & 0x10) == 0) {
        func_global_asm_80714A08(D_global_asm_8075A9B0, D_global_asm_8075A9B4);
...
void func_global_asm_806A7518(void) {
    if ((current_actor_pointer->object_properties_bitfield & 0x10) == 0) {
        ...
        current_actor_pointer->floor = D_global_asm_8075AA70;
        func_global_asm_80665564(current_actor_pointer, 0.0f);
    }
    func_global_asm_806A6DB4(0);
    if (D_global_asm_8075AA74 != current_actor_pointer->floor) {
...
void func_global_asm_806A7BDC(void) {
    ...
    if (!(current_actor_pointer->object_properties_bitfield & 0x10)) {
        ...
        current_actor_pointer->floor = D_global_asm_8075AA78;
        func_global_asm_80665564(current_actor_pointer, 0.0f);
    }
