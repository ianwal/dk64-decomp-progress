...
extern global_asm_struct_78 *D_807F7370[100];

void func_80659320(void) {
    s32 i;

    for (i = 0; i < ARRAY_COUNT(D_807F7370); i++) {
        D_807F7370[i] = NULL;
    }
}
...
s32 func_80659544(s32 arg0) {
    ...
    return (arg0 > 0 ? arg0 : -arg0) % 100; //maybe should be `ARRAY_COUNT(D_807F7370)` instead of 100?
}
