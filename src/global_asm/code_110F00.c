...
void func_global_asm_8070C210(float (*mf)[4], f32, f32, f32, f32, f32, f32);
...
void func_global_asm_8070C2D8(f32 (*arg0)[4], f32 (*arg1)[4], f32 (*arg2)[4]) {
    ...
    r00 = (arg0[0][0] * arg1[0][0]) + (arg0[0][1] * arg1[1][0]) + (arg0[0][2] * arg1[2][0]);
    r01 = (arg0[0][0] * arg1[0][1]) + (arg0[0][1] * arg1[1][1]) + (arg0[0][2] * arg1[2][1]);
    r02 = (arg0[0][0] * arg1[0][2]) + (arg0[0][1] * arg1[1][2]) + (arg0[0][2] * arg1[2][2]);

    r10 = (arg0[1][0] * arg1[0][0]) + (arg0[1][1] * arg1[1][0]) + (arg0[1][2] * arg1[2][0]);
    r11 = (arg0[1][0] * arg1[0][1]) + (arg0[1][1] * arg1[1][1]) + (arg0[1][2] * arg1[2][1]);
    r12 = (arg0[1][0] * arg1[0][2]) + (arg0[1][1] * arg1[1][2]) + (arg0[1][2] * arg1[2][2]);

    r20 = (arg0[2][0] * arg1[0][0]) + (arg0[2][1] * arg1[1][0]) + (arg0[2][2] * arg1[2][0]);
    r21 = (arg0[2][0] * arg1[0][1]) + (arg0[2][1] * arg1[1][1]) + (arg0[2][2] * arg1[2][1]);
    r22 = (arg0[2][0] * arg1[0][2]) + (arg0[2][1] * arg1[1][2]) + (arg0[2][2] * arg1[2][2]);

    r30 = (arg0[3][0] * arg1[0][0]) + (arg0[3][1] * arg1[1][0]) + (arg0[3][2] * arg1[2][0]) + arg1[3][0];
    r31 = (arg0[3][0] * arg1[0][1]) + (arg0[3][1] * arg1[1][1]) + (arg0[3][2] * arg1[2][1]) + arg1[3][1];
    r32 = (arg0[3][0] * arg1[0][2]) + (arg0[3][1] * arg1[1][2]) + (arg0[3][2] * arg1[2][2]) + arg1[3][2];
...
void func_global_asm_8070CDD0(f32 (*arg0)[4], f32 (*arg1)[4], f32 arg2, f32 arg3, f32 arg4) {
    ...
    if ((arg2 == 0.0f) && (arg4 == 0.0f)) {
        if (arg3 == 0.0f) {
            func_global_asm_8070CCC4(arg0);
            func_global_asm_8070CCC4(arg1);
            return;
        }
        sp24 = 0.0f;
        sp2C = 0.0f;
