...
static Struct80755A20 D_global_asm_80755A20[] = {
    ...
    { MAP_JAPES,                                0x0069, 0x0004,                                 ACTOR_DK },
    ...
    { MAP_GALLEON,                              0x002E, 0x00C1,                                 ACTOR_DK },
    ...
    { MAP_GALLEON_MERMAID,                      0x000E, 0x00BF,                                 ACTOR_TINY },
    ...
    { MAP_FUNGI_SPIDER,                         0x0001, 0x00F7,                                 ACTOR_TINY },
    { MAP_FUNGI,                                0x003E, 0x00FD,                                 ACTOR_CHUNKY },
    ...
    { MAP_CAVES_ICE_CASTLE,                     0x0010, 0x010F,                                 ACTOR_LANKY },
    ...
    { MAP_CASTLE_BASEMENT,                      0x000F, 0x0146,                                 ACTOR_DK },
    { MAP_CASTLE_TRASH_CAN,                     0x0004, 0x015F,                                 ACTOR_TINY },
    ...
    { MAP_FAIRY_ISLAND,                         0x001E, 0x012D,                                 ACTOR_TINY },
    // Helm
    { MAP_HELM,                                 0x005D, 0x0248,                                 ACTOR_DK },
    { MAP_HELM,                                 0x005E, 0x0249,                                 ACTOR_CHUNKY },
    { MAP_HELM,                                 0x005F, 0x024A,                                 ACTOR_LANKY },
    { MAP_HELM,                                 0x0060, 0x024B,                                 ACTOR_TINY },
    { MAP_HELM,                                 0x0061, 0x024C,                                 ACTOR_DIDDY },
};
