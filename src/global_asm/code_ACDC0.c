...
void func_global_asm_806A9124(void) {
    s32 temp_t8;
    PlayerAdditionalActorData *new_var;
    s32 i;

    new_var = gPlayerPointer->PaaD;
    temp_t8 = (global_properties_bitfield = global_properties_bitfield | 0x40);
    if (!(new_var->unk1F0 & 0x20000000)) {
