...
void func_8073BB10(f32 arg0, f32 arg1, f32 arg2, f32 *arg3, f32 *arg4) {
    ...
    sp3C = func_80611BB4(arg1 * D_807604B0, arg0);
    sp38 = sp3C * sp3C;
...
void func_8073BE54(Struct8073BC74 *arg0, f32 arg1) {
    ...
    func_8073BB10(arg1, arg0->unk0 + 10.0f, arg0->unk2 / 10.0f, &sp30, &sp24);
...
void func_8073C040(s16 **arg0, Struct8073C040_arg1 *arg1, s16 arg2, s32 arg3) {
    u16 sp36;
    u16 sp34;
    u16 sp32;
    s32 *sp2C;
    ...
    sp2C = NULL;
    sp24 = func_80732444(0, 0, arg3, 1, 0x30);
    *arg0 = sp24;
    ...
    sp24->unk8 = sp2C[sp34++];
    sp24->unk0 = sp2C[sp34++];
    sp24->unk4 = func_80732444(0, 0, arg3, sp24->unk8, 0x28);
    sp24->unk20[0] = func_80732444(0, 0, arg3, sp24->unk0, 2);
    sp24->unk28 = sp24->unk20[0];
    sp24->unk24[0] = func_80732444(0, 0, arg3, sp24->unk0, 2);
    ...
    for (sp36 = 0; sp36 < sp24->unk8; sp36++) {
        ...
        if (sp2C[sp34] != 0) {
            ...
            sp28->unk14 = 1.0f;
            sp28->unk18 = 0;
            sp28->unk24 = func_80732444(0, 0, arg3, 1, 0x38);
            sp28->unk24->unk14 = func_80732444(0, 0, arg3, 1, 0x20);
            sp28->unk24->unk18 = func_80732444(0, 0, arg3, 1, 0x20);
        ...
        if (sp2C[sp34] != 0) {
            sp28->unk20 = func_80732444(0, 0, arg3, 1, 0x38);
            sp28->unk20->unk2C = func_80732444(0, 0, arg3, 1, 8);
            sp28->unk20->unk30 = func_80732444(0, 0, arg3, 1, 8);
            sp28->unk20->unk0 = sp2C[sp34++];
            func_8073BC74(sp28->unk20);
        } else {
            sp28->unk20 = NULL;
            sp34 += 1;
        }
