...
extern f32 D_807F5FE0;

extern f32 D_807F6940;
...
extern u16 D_807F9058;
extern u16 D_807F905A;
extern s32 D_807F905C;
extern s16 D_807F9060;
extern u32 D_807F9064;
extern s32 D_807F9068;

s32 func_8065E0CC(void);
s32 func_8065E81C(s32, s32);
...
void func_8065CE4C(f32 arg0, f32 arg1, f32 arg2, f32 arg3, s16 arg4, s16 *arg5) {
    f32 dx, dy, dz;
    f32 phi_f14;
    ...
    if (current_map == MAP_AZTEC) {
        arg3 = func_8065CFB8(arg4, arg3);
        if (arg3 < phi_f14) {
            *arg5 = 0;
            return;
        }
    }
    dy = func_8065D0FC(arg3);
    dx = (dy * 3.0f) / 4;
    if (phi_f14 < dx) {
        *arg5 = 0xFF;
        return;
...
f32 func_8065CFB8(s16 arg0, f32 arg1) {
    if (arg0 == 0xB2 || arg0 == 0x253) {
        arg1 += (D_80758D60 - arg1) * D_807F6940;
    }
    return arg1;
}
...
f32 func_8065D0FC(f32 arg0) {
    if (D_80758D68 == character_change_array[cc_player_index].fov_y) {
        return arg0;
    }
...
void func_8065D964(GlobalASMStruct66 *arg0, s16 arg1, s16 arg2, s16 arg3, s16 arg4) {
    arg0->unk0 = arg1;
    arg0->unk2 = 0;
    arg0->unk4 = arg2;
    arg0->unk8 = arg3 << 5;
...
s32 func_8065EA44(void) {
    D_807F9064 = (D_807F9064 * 3) >> 2;
    if (D_807F9064 < 0x10000) {
        return 0;
    }
    return func_8065E81C(1, 0);
}
...
void func_8065EACC() {
    if (D_807F9064 != 40000) {
        D_807F9068 = D_807F9064;
    }
    D_807F9064 = 40000;
}

void func_8065EAF4() {
    D_807F9064 = D_807F9068;
}
