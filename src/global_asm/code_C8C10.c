...
extern f32 D_global_asm_8075C260;
...
void func_global_asm_8061C464(s32, Actor *, s32, s16, s32, s32, s32, s32, s32, s32, f32);
...
void func_global_asm_806C3F10(u8 arg0, u8 arg1, u8 arg2) {
    ...
    if (!(current_actor_pointer->object_properties_bitfield & 0x10)) {
        ...
        if (arg2 != 0) {
            ...
            func_global_asm_8061C518(D_global_asm_807F5D10, current_actor_pointer, 4, 0x800, 0x19, 0, 0xA, 0x14, 0xC, 0, D_global_asm_8075C260);
        }
        D_global_asm_807FDC9C->unk10 = 0x27;
        current_actor_pointer->control_state = 0x27;
        current_actor_pointer->control_state_progress = 0;
    }
    var_v1->unk0 = MAX(0, D_global_asm_807FDC90->unkC - D_global_asm_807FDC9C->unk6);
    // temp_v0 = D_global_asm_807FDC90->unkC - D_global_asm_807FDC9C->unk6;
    // if (temp_v0 < 0) {
        // var_v1->unk0 = 0;
    // } else {
        // var_v1->unk0 = temp_v0;
        ...
        case 39:
            if ((D_global_asm_807FDC90->unk1A & 4) && (arg0 == (D_global_asm_807FDC90->unk25 & 0x7F))) {
                if (character_change_array->unk2C0 == 0) {
                    func_global_asm_8070D8C0(current_actor_pointer, 0x10, 1, current_actor_pointer);
                    ...
                    func_global_asm_8070D8C0(current_actor_pointer, 0x10, 0, current_actor_pointer);
                    current_actor_pointer->control_state = 0x28;
                    current_actor_pointer->control_state_progress = 0;
                    D_global_asm_807FDC9C->unk10 = 0x28;
                    if (arg2 == 0) {
                        func_global_asm_8061C464(D_global_asm_807F5D10, current_actor_pointer, 4, 0x800, 0x19, 0, 0xA, 0x14, 0xC, 0x78, D_global_asm_8075C264);
                    }
                }
            }
            // fallthrough
        ...
        case 41:
            if (D_global_asm_807FDC90->unk1A & 0x8000) {
                if ((D_global_asm_807FDC90->unk1A & 4) && (arg1 == (D_global_asm_807FDC90->unk25 & 0x7F))) {
                    ...
                    if (arg2 == 0) {
                        func_global_asm_8061C464(D_global_asm_807F5D10, player_pointer, 4, object_timer * 0x14, 0x1E, 0, 0xA, 0x1E, 0xC, 0, D_global_asm_8075C268);
                    }
            ...
            func_global_asm_806B49B0(var_v0, 0x23D, 0x23E);
            // fallthrough
        case 0:
            return;
    }
