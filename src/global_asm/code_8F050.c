...
s32 func_80612E90(Actor*, s16, s32);
...
void func_8068A508(void) {
    ...
    for (i = 0; i < D_807FBB34; i++) {
        ...
        if (!(temp_s0->object_properties_bitfield & 0x2000) && (temp_s0->object_properties_bitfield & 0x100)) {
            ...
            if (func_8068A3A0(temp_s0->unk58, &sp80) != 0) {
                temp_f0_2 = func_8065D0FC(D_80750100[sp80].unk4);
                switch (D_80750100[sp80].unk8) {
                    case 0:
                        if (cc_number_of_players >= 2) {
                            temp_a2 = D_807552F4[temp_s0->PaaD->unk1A4];
                            if (temp_a2 >= 0) {
                                func_8068A404(temp_s0, sp80, temp_a2);
                            }
                        }
                        break;
                    case 1:
                        if ((temp_f0_2 * temp_f0_2) < temp_f20) {
                            if (temp_s0->unk4C == 0) {
                                temp_s0->unk4C = func_80612E90(temp_s0, D_80750100[sp80].unk2, 0);
                            }
                        } else if (temp_s0->unk4C != 0) {
                            func_80613794(temp_s0, 1);
                        }
                        break;
                    case 2:
