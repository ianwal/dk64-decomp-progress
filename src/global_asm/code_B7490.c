...
void func_global_asm_806B2D64(void) {
    ...
    switch (current_actor_pointer->control_state) {
        ...
        case 0x27:
            switch (current_actor_pointer->control_state_progress) {
                case 0:
                    playActorAnimation(current_actor_pointer, 0x2E6);
                    current_actor_pointer->control_state_progress = 1;
                    break;
                case 2:
                    current_actor_pointer->unk132 = 2;
        ...
        case 0x25:
            switch (current_actor_pointer->control_state_progress) {
                case 0:
                    playActorAnimation(current_actor_pointer, 0x2E4);
                    current_actor_pointer->control_state_progress = 1;
                    break;
                case 2:
                    func_global_asm_80690814(current_actor_pointer, 1);
                    func_global_asm_8069084C(0x112, 0, 0.3f, current_actor_pointer->y_rotation, 300.0f, func_global_asm_80612794(current_actor_pointer->z_rotation) * 300.0f, current_actor_pointer);
        ...
        case 0x23:
            func_global_asm_806B2D5C();
            var_f2 = MIN(current_actor_pointer->unkAC - current_actor_pointer->unk15E, D_global_asm_807FDC94->y_position);
            func_global_asm_8072A920(current_actor_pointer->control_state, 0, D_global_asm_807FDC94->x_position, var_f2, D_global_asm_807FDC94->z_position, 0x1E, 3.3f, 100.0f, 0x2040);
            if (D_global_asm_807FBD70 == 2) {
                current_actor_pointer->control_state = 0x27;
                current_actor_pointer->control_state_progress = 0;
            }
        ...
        case 0x35:
            func_global_asm_806B2D5C();
            var_f2 = MIN(D_global_asm_807FDC90->unkC, current_actor_pointer->unkAC - current_actor_pointer->unk15E);
            func_global_asm_8072A920(current_actor_pointer->control_state, 0, D_global_asm_807FDC90->unkA, var_f2, D_global_asm_807FDC90->unkE, 0x1E, 3.3f, 100.0f, 0x2040);
            break;
        case 0x37:
            switch (current_actor_pointer->control_state_progress) {
                case 0:
...
s32 func_global_asm_806B3F90(GlobalASMStruct91 *arg0, u8 arg1) {
    ...
    current_actor_pointer->z_rotation = func_global_asm_806CC190(current_actor_pointer->z_rotation, (func_global_asm_80665E94(arg0->unkA, arg0->unkC, arg0->unkE, current_actor_pointer->x_position, current_actor_pointer->y_position, current_actor_pointer->z_position, 0x46) * 2048.0) / M_PIF, 3.3f);
...
void func_global_asm_806B42A8(int (*arg0)(), u16 arg1, u16 arg2, s16 arg3) {
    ...
    if ((arg3 != 0) && (current_actor_pointer->control_state != 0x37) && (current_actor_pointer->unk6E[0] == -1)) {
        func_global_asm_80604CBC(current_actor_pointer, arg3, 0, 0, 0, 0xFF, 1.0f, 0);
    }
    if (!(current_actor_pointer->object_properties_bitfield & 0x10)) {
    ...
    switch (current_actor_pointer->control_state) {
        ...
        case 0x7:
        case 0x35:
            if (current_actor_pointer->y_position < (D_global_asm_807FDC9C->unk6 + a178->unk0)) {
                current_actor_pointer->y_position += (D_global_asm_807FDC9C->unkA_u8[1] * 0.03125);
            } else {
                if ((func_global_asm_8061CB50() == 0) && (arg0 != NULL)) {
                    arg0();
                }
            }
            func_global_asm_8072AB74(current_actor_pointer->control_state, var_t0, var_t1, 0x2C1, 0.0f);
        ...
        case 0x26:
            switch (current_actor_pointer->control_state_progress) {
                case 0:
                    ...
                    // fallthrough
                case 1:
                    if ((func_global_asm_806B3F90(D_global_asm_807FDC90, 0x23) & 1) || ((current_actor_pointer->y_position < (D_global_asm_807FDC90->unkC + 0xF)))) {
        ...
        case 0x37:
            ...
            switch (current_actor_pointer->control_state_progress) {
                ...
                case 1:
                    ...
                    if (current_actor_pointer->unk58 == ACTOR_BAT) {
                        current_actor_pointer->control_state_progress = 3;
                        break;
                    } else {
