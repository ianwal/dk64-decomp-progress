    ...
    switch (current_actor_pointer->unk58) {
        case ACTOR_SPOTLIGHT_FISH:
            if (current_actor_pointer->object_properties_bitfield & 0x100) {
                func_80671C0C(current_actor_pointer, 1, &sp64, &sp68, &sp6C);
            } else {
                sp64 = current_actor_pointer->x_position;
                sp68 = current_actor_pointer->y_position;
                sp6C = current_actor_pointer->z_position;
            }
            if ((D_8075C380 < (((current_actor_pointer->x_position - player_pointer->x_position) * (current_actor_pointer->x_position - player_pointer->x_position))
                ...
                func_80671C0C(current_actor_pointer, 2, &sp70, &sp74, &sp78);
            } else {
                sp70 = player_pointer->x_position;
                sp74 = player_pointer->y_position;
                sp78 = player_pointer->z_position;
            }
            func_8065A660(30.0f, 80.0f);
            break;
        case ACTOR_SPOTLIGHT_SQUAWKS:
            sp64 = current_actor_pointer->x_position;
            sp68 = current_actor_pointer->y_position;
            sp6C = current_actor_pointer->z_position;
            sp70 = (func_80612794(current_actor_pointer->y_rotation) * 40.0f) + current_actor_pointer->x_position;
            sp74 = current_actor_pointer->y_position - 20.0f;
            sp78 = (func_80612790(current_actor_pointer->y_rotation) * 40.0f) + current_actor_pointer->z_position;
            func_8065A660(20.0f, 40.0f);
            break;
    }
    sp8C->unk0 = (func_80612794(object_timer * 0x82) * D_8075C388) + D_8075C390;
    func_8065A708(sp64, sp68, sp6C, sp70, sp74, sp78, 0.0f, 1, sp8C->unk0, sp8C->unk0, sp8C->unk0);
}
...
void func_806C6884(s16 arg0, s16 arg1, u16 arg2) {
    ...
    current_actor_pointer->y_position += 0.5 * func_80612794(object_timer * 0x28);
    func_806C6530();
