...
s32 func_806FE078(Gfx *, u8, s32, f32, f32, f32, f32);
void *func_8070068C(void *);
...
Gfx *func_80024000(Gfx *dl, Actor *arg1) {
    A178_80024000 *a178;
    a178 = arg1->unk178;
    if (func_805FCA64() != 0) {
        ...
        dl = func_8068DC54(func_806FE078(dl, a178->unk9, 8, 30.0f, 36.0f, 0.0f, 1.5f), 0x26, 0x32, &a178->unk2, a178->unk4, &a178->unk8);
    }
    return dl;
}
